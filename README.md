...
- Run the [full install script](https://raw.githubusercontent.com/Daksh777/SpotifyNoPremium/main/fullautoinstall.ps1) which installs Git + Spicetify CLI (can be cancelled if already installed) + theme. <br> <br>
OR <br> <br>
